  ...
  secrets = [
    {
      ...
      value = module.application_insights.nodejs.instrumentation_key
      tags = {
        "source" = "App Insights"
      }
      content_type    = ""
    ...
    },
    {
      ...
      value = module.application_insights.java.instrumentation_key
      tags = {
        "source" = "App Insights"
      }
      content_type    = ""
    ...
    },
    {
      ...
      value = module.application_insights.java.connection_string
      tags = {
        "source" = "App Insights"
      }
      content_type    = ""
